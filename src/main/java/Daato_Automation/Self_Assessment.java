...
//	driver.findElement(By.xpath("//input[@id='password']")).sendKeys("681993@Virat");
		...
		WebElement element25 = driver.findElement(By.xpath(
				"//p[contains(text(),'Can you confirm that your company has a management person responsible for environment sustainability?')]"));
		...
		WebElement element26 = driver.findElement(By.xpath(
				"//p[contains(text(),'Can you confirm that your company has a management person responsible for monitoring sustainability risks (e.g. a Human Rights Officer)?')]"));
		...
		WebElement element27 = driver
				.findElement(By.xpath("//p[contains(text(),'Can you confirm that your company has a Code of Co')]"));
		...
		WebElement element29 = driver.findElement(
				By.xpath("//p[contains(text(),'What kind of complaints can be submitted? Tick all that apply')]"));
	...
	public void Add_Buisness_Ethics() throws InterruptedException {
		...
		WebElement element33 = driver.findElement(
				By.xpath("//p[contains(text(),'Does your company have a formal policy covering business ethics?')]"));
	...
	public void Add_responsible_supply_chain_management() throws InterruptedException {
		...
		WebElement element4 = driver
				.findElement(By.xpath("//p[contains(text(),'Responsible supply chain management')]"));
		...
		WebElement element44 = driver.findElement(By.xpath(
				"//p[contains(text(),'Please tick the areas that are covered by the sustainability requirements towards suppliers')]"));
	...
	public void add_policies_and_certifications() throws InterruptedException {
		...
		WebElement element6 = driver
				.findElement(By.xpath("//p[contains(text(),'Does your site have an environmental management sy')]"));
		...
		WebElement element8 = driver
				.findElement(By.xpath("//p[contains(text(),'Does your company have a formal policy covering wo')]"));
	...
	public void add_policy_part_second() throws InterruptedException {
		...
		WebElement element9 = driver
				.findElement(By.xpath("//p[contains(text(),'Occupational Health and safety policy')]"));
		...
		driver.findElement(By.xpath("//li[@id='searchSelectID-main-option-0']")).click();
		Thread.sleep(3000);
		WebElement element91 = driver.findElement(By.xpath(
				"//p[contains(text(),'Please tick all that is covered in your occupational health and safety policy')]"));
		...
		WebElement element10 = driver
				.findElement(By.xpath("//p[contains(text(),'Does your company have a formal environmental poli')]"));
		...
		WebElement element15 = driver.findElement(By.xpath(
				"//p[contains(text(),'Which of the following areas are covered by this policy? Please tick all that apply.')]"));
	...
	public void add_chld_frc_hs_fa_ee_fw_lr() throws InterruptedException {
		...
		WebElement element21 = driver.findElement(By.xpath(
				"//p[contains(text(),'Do you organise training for all your employees on your policy covering land rights?')]"));
	...
	public void add_cs_sw() throws InterruptedException {
		...
		WebElement element22 = driver
				.findElement(By.xpath("//p[contains(text(),'Can you confirm that your company does not hire')]"));
		...
		WebElement element12 = driver
				.findElement(By.xpath("//p[contains(text(),'Systematic or widespread human rights abuses')]"));
		...
		WebElement element13 = driver
				.findElement(By.xpath("//p[contains(text(),'Do you get legal advice on compliance, contract ne')]"));
