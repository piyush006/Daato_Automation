...
public class Self_Assessment_Low extends Base_Class{
	...
	public void General_information() throws InterruptedException {
		...
		Xls_Reader reader = new Xls_Reader("C:\\Users\\47Billion\\Desktop\\xlsx\\Add_Supplier_Afghanistan.xlsx");
		 ...
		 for(int i=0;i<count-1;i++) {
			 ...
			 User_Registered=reader.getCellData("Add_supplier_Full_Sanity", "User_Registered", i+2);
			 
			 if(User_Registered.equals("No")) {
				 
			 Email=reader.getCellData("Add_supplier_Full_Sanity", "Contact_Email", i+2); 
		...
		Thread.sleep(3000);
		reader.setCellData("Add_supplier_Full_Sanity","User_Registered",i+2,"Yes");
        Thread.sleep(2000);
