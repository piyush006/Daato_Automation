...
public class Risk_Priority_High extends Base_Class{
...
Xls_Reader reader = new Xls_Reader("C:\\Users\\47Billion\\Desktop\\xlsx\\Add_Supplier_Afghanistan.xlsx");
 ...
 int count = reader.getRowCount("self_assessment_saq_high");
 
for (int i=0;i<count-1;i++) {
	 
	 String Expected =reader.getCellData("self_assessment_saq_high","Expected_Status_After_SAQ",i+2);
...
for (int j=0;j<13;j++) {
	...
	reader.setCellData("self_assessment_saq_high","Actual_Status_After_SAQ",j+2,Actual_Result.get(j));	
