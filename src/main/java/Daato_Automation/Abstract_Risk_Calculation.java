...
public class Abstract_Risk_Calculation extends Base_Class {
	...
	public void to_verify_abstrac_risk() throws InterruptedException {
		 ...
		 * xpath("//p[@class='sc-breuTD dAOWMV MuiTypography-root MuiTypography-body1 MuiTypography-alignCenter']"
		 * )).click(); driver.findElement(By.id("menuItemId-profile")).click();
		 ...
		 * String Success = wait.until(ExpectedConditions.visibilityOfElementLocated(By.
		 * xpath("//p[@class='sc-breuTD liTfKa MuiTypography-root MuiTypography-body1']"
		 * ))).getText();
		 * 
		 * System.out.println(Success); driver.findElement(By.
		 * xpath("//*[name()='path' and contains(@d,'M12 4.7L11')]")).click();
		 * 
		 * Thread.sleep(2000);
		 */
		...
		// driver.findElement(By.xpath("//p[contains(text(),'Supply Chain
		// Risk')]")).click();

		// driver.findElement(By.xpath("//span[normalize-space()='Suppliers
		// repository']")).click();
		...
		// driver.findElement(By.xpath("//input[@class='sc-jsJBEP sc-cWSHoV ZRXBW cxNqZI
		// MuiInputBase-input MuiOutlinedInput-input
		// MuiInputBase-inputAdornedEnd']")).sendKeys("Autosupplier");
		Thread.sleep(2000);
